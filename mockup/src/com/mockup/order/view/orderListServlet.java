	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		for(int i=0;i<orderlist.size();i++){
			...
			out.println("			<tr>");
			 ...
			 out.println("					<input type=\"button\" value=\"删除\" onclick=\"javascript:window.location='logoncheck/toorderlist';\">&nbsp;");
			 out.println("					<input type=\"button\" value=\"明细\" onclick=\"javascript:window.location='logoncheck/toorderdetail?orderid="+order.getOrderid()+"&paywayid="+order.getPaywayid()+"';\">");
			 out.println("				</td>");
			 out.println("			</tr>");
		}
